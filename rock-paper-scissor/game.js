...
document.getElementById("button-rock").addEventListener("click", () => {
    playRound(rock);
}); 
document.getElementById("button-paper").addEventListener("click", () => {
    playRound(paper);
}); 
document.getElementById("button-scissor").addEventListener("click", () => {
    playRound(scissor);
});
